...
export default function EntryForm() {
  ...
  async function exportMyData() {
    ...
    ws['!cols'] = [{ wch: 6 }, { wch: 12 }, { wch: 12 }, { wch: 12 }, { wch: 14 }, { wch: 20 }, { wch: 14 }, { wch: 12 }, { wch: 8 }, { wch: 10 }, { wch: 10 }]
              ...
              <table className="data-table">
                <thead>
                  <tr>
                    ...
                    <th>Hours</th><th>Allocated</th><th>Done</th><th>Remaining</th><th>Status</th>{editMode && <th>Actions</th>}
                  </tr>
                </thead>
                <tbody>
